...
public partial class GRADE : System.Web.UI.Page
{
    ...
    protected void Button2_Click1(object sender, EventArgs e)
    {
        ...
        if (s == 1 && c == 1)
        {
            ...
            cmd.CommandText = "insert into GRADE values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "')";
            cmd.ExecuteNonQuery();
    ...
    protected void Button3_Click1(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = conn.CreateCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = "update GRADE set Cls_ID='" + TextBox2.Text + "',Cls_name='" + TextBox3.Text + "',Grade_Total='" + TextBox4.Text + "',Grade='" + TextBox5.Text + "' where Student_ID='" + TextBox1.Text + "'";
        cmd.ExecuteNonQuery();
    ...
    protected void Button4_Click1(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = conn.CreateCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = "delete from GRADE  where Student_ID='" + TextBox1.Text + "'";
        cmd.ExecuteNonQuery();
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd1 = conn.CreateCommand();
        cmd1.CommandType = CommandType.Text;
        cmd1.CommandText = "select * from GRADE where Student_ID='" + TextBox1.Text + "'";
