<%@ Page Language="C#" AutoEventWireup="true" CodeFile="STUDENT_ADMISSION.aspx.cs" Inherits="STUDENT_REGISTRATION" %>
...
<body style="height: 528px; width: 50%;" >
    ...
    <table border="0" class="auto-style1">
        <th colspan="2" class="auto-style8">
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="True" ForeColor="#666699" Text="Student Admission"></asp:Label>
        </th>
        <tr>
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="17pt" Text="Enrroll Date"></asp:Label>
            </td>
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="17pt" Text="Class"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="17pt" Text="Student ID"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="17pt" Text="Enrroll Fee"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="17pt" Text="Full Name"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="17pt" Text="Gender"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Size="17pt" Text="Father's Name"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="17pt" Text="Mother's Name"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Size="17pt" Text="P Address"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Size="17pt" Text="Pre Address"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label13" runat="server" Font-Bold="True" Font-Size="17pt" Text="District"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Size="17pt" Text="Date Of Birth"></asp:Label>
            </td>
            <td class="auto-style7">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="17pt" Text="Religion"></asp:Label>
            </td>
            <td class="auto-style7">
                <asp:TextBox ID="TextBox14" runat="server" Height="33px" Width="98%" Font-Bold="True" Font-Size="15pt" ForeColor="#666666"></asp:TextBox>
            </td>
            <tr>
            <td class="auto-style2">
                <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Size="17pt" Text="Email ID"></asp:Label>
            </td>
            <td class="auto-style7">
                <asp:TextBox ID="TextBox15" runat="server" Height="33px" Width="98%" Font-Bold="True" Font-Size="15pt" ForeColor="#666666"></asp:TextBox>
            </td>
                <tr>
            <td class="auto-style2">
                <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Size="17pt" Text="Mobile No"></asp:Label>
            </td>
            <td class="auto-style7">
                <asp:TextBox ID="TextBox16" runat="server" Height="33px" Width="98%" Font-Bold="True" Font-Size="15pt" ForeColor="#666666"></asp:TextBox>
            </td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="Enrroll_Date" HeaderText="Enrroll_Date" SortExpression="Enrroll_Date" />
                <asp:BoundField DataField="Class" HeaderText="Class" SortExpression="Class" />
                <asp:BoundField DataField="Student_ID" HeaderText="Student_ID" SortExpression="Student_ID" />
                <asp:BoundField DataField="Enrroll_Fee" HeaderText="Enrroll_Fee" SortExpression="Enrroll_Fee" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [STUDENT_REGISTRATION]"></asp:SqlDataSource>
